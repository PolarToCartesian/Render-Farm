...
void Vector3D::add(const double& _x, const double& _y, const double& _z, const double& _w, const bool& _useW) {
	this->x += _x; this->y += _y; this->z += _z;

	if (_useW) this->w += _w;
}

void Vector3D::add(const double& _x, const double& _y, const double& _z) { this->x += _x; this->y += _y; this->z += _z; }
void Vector3D::add(const double& _x, const double& _y) { this->x += _x; this->y += _y; }
void Vector3D::add(const Vector3D& _v, const bool& _useW) { this->add(_v.x, _v.y, _v.z, _v.w, _useW); }
void Vector3D::add(const double& _n, const bool& _useW) { this->add(_n, _n, _n, _n, _useW); }
void Vector3D::operator+=(const Vector3D& _a) { this->add(_a); }
void Vector3D::operator+=(const double& _a) { this->add(_a); }
Vector3D Vector3D::operator+(const Vector3D& _a) const { Vector3D result = this->copy(); result.add(_a); return result; }
Vector3D Vector3D::operator+(const double& _a)   const { Vector3D result = this->copy(); result.add(_a); return result; }



void Vector3D::sub(const double& _x, const double& _y, const double& _z, const double& _w, const bool& _useW) {
	this->x -= _x; this->y -= _y; this->z -= _z;

	if (_useW) this->w -= _w;
}

void Vector3D::sub(const double& _x, const double& _y, const double& _z) { this->x -= _x; this->y -= _y; this->z -= _z; }
void Vector3D::sub(const double& _x, const double& _y) { this->x -= _x; this->y -= _y; }
void Vector3D::sub(const Vector3D& _v, const bool& _useW) { this->sub(_v.x, _v.y, _v.z, _v.w, _useW); }
void Vector3D::sub(const double& _n, const bool& _useW) { this->sub(_n, _n, _n, _n, _useW); }
void Vector3D::operator-=(const Vector3D& _a) { this->sub(_a); }
void Vector3D::operator-=(const double& _a) { this->sub(_a); }
Vector3D Vector3D::operator-(const Vector3D& _a) const { Vector3D result = this->copy(); result.sub(_a); return result; }
Vector3D Vector3D::operator-(const double& _a)   const { Vector3D result = this->copy(); result.sub(_a); return result; }


void Vector3D::mul(const double& _x, const double& _y, const double& _z, const double& _w, const bool& _useW) {
	this->x *= _x; this->y *= _y; this->z *= _z;

	if (_useW) this->w *= _w;
}

void Vector3D::mul(const double& _x, const double& _y, const double& _z) { this->x *= _x; this->y *= _y; this->z *= _z; }
void Vector3D::mul(const double& _x, const double& _y) { this->x *= _x; this->y *= _y; }
void Vector3D::mul(const Vector3D& _v, const bool& _useW) { this->mul(_v.x, _v.y, _v.z, _v.w, _useW); }
void Vector3D::mul(const double& _n, const bool& _useW) { this->mul(_n, _n, _n, _n, _useW); }
void Vector3D::operator*=(const Vector3D& _a) { this->mul(_a); }
void Vector3D::operator*=(const double& _a) { this->mul(_a); }
Vector3D Vector3D::operator*(const Vector3D& _a) const { Vector3D result = this->copy(); result.mul(_a); return result; }
Vector3D Vector3D::operator*(const double& _a)   const { Vector3D result = this->copy(); result.mul(_a); return result; }



void Vector3D::div(const double& _x, const double& _y, const double& _z, const double& _w, const bool& _useW) {
	this->x /= _x; this->y /= _y; this->z /= _z;

	if (_useW) this->w /= _w;
}

void Vector3D::div(const double& _x, const double& _y, const double& _z) { this->x /= _x; this->y /= _y; this->z /= _z; }
void Vector3D::div(const double& _x, const double& _y) { this->x /= _x; this->y /= _y; }
void Vector3D::div(const Vector3D& _v, const bool& _useW) { this->div(_v.x, _v.y, _v.z, _v.w, _useW); }
void Vector3D::div(const double& _n, const bool& _useW) { this->div(_n, _n, _n, _n, _useW); }
void Vector3D::operator/=(const Vector3D& _a) { this->div(_a); }
void Vector3D::operator/=(const double& _a) { this->div(_a); }
Vector3D Vector3D::operator/(const Vector3D& _a) const { Vector3D result = this->copy(); result.div(_a); return result; }
Vector3D Vector3D::operator/(const double& _a)   const { Vector3D result = this->copy(); result.div(_a); return result; }


void Vector3D::normalize() { this->div(this->getLength()); }
void Vector3D::setLength(const double& _l) { this->normalize(); this->mul(_l); }

Vector3D Vector3D::copy() const { return Vector3D(this->x, this->y, this->z, this->w); }

double Vector3D::getLength() const { return std::sqrt(std::pow(this->x, 2) + std::pow(this->y, 2) + std::pow(this->z, 2)); }

void Vector3D::constrain(const double& _min, const double& _max) {
...
void Vector3D::constrainW(const double& _min, const double& _max) {
