...
void PerspectiveCamera::calculateRotationMatrices() {
...
void PerspectiveCamera::applyRotation(Vec3& _vertex) const {
...
bool PerspectiveCamera::isTriangleFacingCamera(const std::array<Vec3, 3>& _points, const Vec3& _triangleSurfaceNormal) const {
